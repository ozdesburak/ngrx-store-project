...
export declare class MockStore<T = object> extends Store<T> {
     ...
     */
    refreshState(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MockStore<any>, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<MockStore<any>>;
}
export {};

//# sourceMappingURL=mock_store.d.ts.map